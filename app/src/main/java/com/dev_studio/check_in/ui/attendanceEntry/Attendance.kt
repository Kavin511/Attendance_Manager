package com.dev_studio.check_in.ui.attendanceEntry
...
import com.dev_studio.check_in.util.toast
import com.dev_studio.check_in.databinding.FragmentAttendanceEntryBinding
...
class Attendance : Fragment(), CompletionHandler {
    ...
    fun setTimeToTimePickers(time: TimePicker, timeSpec: TimeModel) {
